...
import useAuth from '@/hooks/auth/use-signin';
...
export const SignInPage = () => {
  ...
  const { handleSignIn, error, loading, success } = useAuth();
            ...
            <div className="absolute bottom-0 left-0 w-full p-12 z-10">
              <div className="space-y-4 max-w-md">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tight leading-tight">
                  Parking made <br className="hidden lg:block" />
                  brilliant.
                </h2>
                <p className="text-lg text-gray-300 font-light max-w-sm">
                  Experience the smartest way to reserve and manage your parking
                  spaces worldwide.
                </p>
              </div>
            </div>
